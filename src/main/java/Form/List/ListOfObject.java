...
//import AdminForm.Revisit.NewRevisit;
...
//import Form.Invoice.NewInvoice;
...
import static Enum.TypeList.Bill;
...
public class ListOfObject extends javax.swing.JPanel {
    ...
    private void InitDate()
    {
        ...
        switch (list) {
            case Drug -> {
                TitleTable.setText("Danh Sách Thuốc");
                textSeachID.setLabelText("ID Thuốc");
                textSeachName.setLabelText("Tên Thuốc");
            ...
            case Employee -> {
                TitleTable.setText("Danh sách nhân viên");
                textSeachID.setLabelText("Tìm ID");
                textSeachName.setLabelText("Tìm theo tên NV");
                btnNew.setText("Nhân viên mới");
                model.addColumn("#");
            ...
            case Patient -> { // QQuynhf Patient    
                TitleTable.setText("Danh Sách Bệnh Nhân");
                textSeachID.setLabelText("Tìm Kiếm CID");
                textSeachName.setLabelText("Tìm Kiếm Bệnh Nhân");
                btnNew.setText("Thêm Bệnh Nhân ");
                model.addColumn("#");
                model.addColumn("Họ Và Tên");
                model.addColumn("Ngày Sinh");
                model.addColumn("Giới Tính");
            ...
            case Services -> {
                TitleTable.setText("Danh sách dịch vụ");
                textSeachID.setLabelText("Tìm ID");
                textSeachName.setLabelText("Tìm tên dịch vụ");
                btnNew.setText("Dịch vụ mới");
                model.addColumn("#");
                ...
                TitleTable.setText("Danh sách hóa đơn"); // bà sua may cái tên nay thanh hoa đon với bill cho hợp lý tự sua nha
                textSeachID.setLabelText("Tìm ID");
                textSeachName.setLabelText("Tìm tên dịch vụ");
                btnNew.setText("Hoá đơn mới");
                model.addColumn("#");
                model.addColumn("Tên Dịch Vụ");
                model.addColumn("Giá");
                model.addColumn("Mô tả");
    ...
    private void initComponents() {
        ...
        btnNew.getAccessibleContext().setAccessibleParent(jPanel1);
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        switch (list) {
            ...
            case Bill -> {
                 showForm(new NewInvoice(main, TypeInterface.Create, this.employeecurrent));
            }

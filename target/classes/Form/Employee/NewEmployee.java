...
public class NewEmployee extends javax.swing.JPanel {
    ...
    private boolean initCreateData()
    {
          ...
          if(!"".equals(txtUserName.getText().trim()))
        {
            ...
            showMessage("User Name không thể để trốngg", TypeNotification.Warning);
            return false;
        }
        
         if(!"".equals(txtPassword.getText().trim()))
        {
            employee.setPassword(txtPassword.getText().trim());
        }
        else{
            showMessage("User Name không thể để trốngg", TypeNotification.Warning);
            return false;
      ...
      employee.setRoleName(JRole.getSelectedItem().toString());
     ...
     * regenerated by the Form Editor.Sreas
     */
    ...
    private void initComponents() {
        ...
        TitleTable1.setText("Chọn bác sĩ");
        ...
        txtPassword.setBackground(new java.awt.Color(238, 245, 255));
        txtPassword.setColumns(1);
        txtPassword.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtPassword.setToolTipText("");
        txtPassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(126, 175, 255), 2));
        ...
        txtUserName.setBackground(new java.awt.Color(238, 245, 255));
        txtUserName.setColumns(1);
        txtUserName.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtUserName.setToolTipText("");
        txtUserName.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(126, 175, 255), 2));
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(txtPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 532, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(JBirthday, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(jLabel8))

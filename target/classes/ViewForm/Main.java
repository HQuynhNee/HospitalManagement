    ...
    private void init() {
        ...
        menu.setEvent((int index) -> {
            switch (index) {
                ...
                case 5 -> showForm(new ListOfObject(main, TypeList.Bill, this.employee));
                default -> {
                }
            }
        });
        ...
        menu.addMenu(new ModelMenu("Bill", new ImageIcon(getClass().getResource("/Images/Icons/CardMedicine.png"))));//Bill Thuốc
